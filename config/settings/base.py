...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "plan": get_str("THROTTLE_USER_RATE", default="100/minute"),  # fallback for TenantPlanThrottle
    },
...
BILLING_PORTAL_URL = get_str("BILLING_PORTAL_URL", default=f"{get_str('FRONTEND_URL', default='http://localhost:3000')}/billing")
...
LOGGING = get_logging_config(json_logs=STRUCTLOG_JSON)
        get_int("JWT_REFRESH_TOKEN_LIFETIME_DAYS", default=7)),
    "ROTATE_REFRESH_TOKENS": True,
    "BLACKLIST_AFTER_ROTATION": True,
}
...
EMAIL_BACKEND = get_str("EMAIL_BACKEND", default="django.core.mail.backends.console.EmailBackend")
DEFAULT_FROM_EMAIL = get_str("DEFAULT_FROM_EMAIL", default="noreply@example.com")
EMAIL_HOST = get_str("EMAIL_HOST", default="")
EMAIL_PORT = get_int("EMAIL_PORT", default=587)
EMAIL_HOST_USER = get_str("EMAIL_HOST_USER", default="")
...
CORS_ALLOWED_ORIGINS = get_csv("CORS_ALLOWED_ORIGINS", default="http://localhost:3000")
